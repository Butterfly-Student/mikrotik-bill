import { Activity, BarChart3, Clock, CreditCard, DollarSign, Home, MessageSquare, Receipt, Router, Settings, Settings2, Shield, StickyNote, UserCheck, Users, Wifi } from "lucide-react";
// Navigation Types
interface NavigationItem {
  title: string;
  url: string;
  icon?: any; // You can replace with specific icon type from your icon library
  isActive?: boolean;
  permission: string;
...
type NavigationConfig = NavigationItem[];
